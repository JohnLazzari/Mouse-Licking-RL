...
class FixedPointFinderBase(object):
    ...
    def find_fixed_points(self, initial_states, inputs, region_start, region_end, cond_ids=None):
        ...
        if self.method == 'sequential':
            ...
            all_fps = self._run_joint_optimization(
                initial_states, inputs_nxd, region_start, region_end, cond_ids=cond_ids)
        else:
